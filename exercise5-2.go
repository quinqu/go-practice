...
var palette2 = []color.Color{color.White, color.Black, color.RGBA{130, 20, 76, 1}, color.RGBA{30, 90, 200, 1}}

const (
	whiteIndex1 = 0 // first color in palette2
